...
<!-- 	<div id="ims 		the header image bellow
		<img src="IMAGES\chh.png">
		
	</div>  register -->
	<div id="Create" class="tabcontent">
  <!-- Regester Form here --> 
    <h2 style="color:yellow;" align="center">permission to renew</h2>
        ...
        <input type="submit" name="uploaduser" value="upload Profile Photo" id="up_btn">
          ...
          &nbsp;&nbsp;<lable style="color:yellow;">house no</lable>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="user_name"id="txt4"><br><br>
          &nbsp;&nbsp;<label style="color:yellow;">wereda</lable>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="Password" name="pass_name"id="txtpass"><br><br>
          &nbsp;&nbsp;<label style="color:yellow;">reason to renew</lable>&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="m_name"id="txt2"><br><br>
