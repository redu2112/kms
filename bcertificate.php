...
<!-- 	<div id="ims">
  ...
  <!-- Regester Form here --> 
    <h2 style="color:yellow;" align="center">Birth Certificate</h2>
        ...
        <input type="submit" name="uploaduser" value="upload Profile Photo" id="up_btn">
          ...
          &nbsp;&nbsp;<lable style="color:yellow;">mother name</lable>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="user_name"id="txt4"><br><br>
          &nbsp;&nbsp;<label style="color:yellow;">father name</lable>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="Password" name="pass_name"id="txtpass"><br><br>
          &nbsp;&nbsp;<label style="color:yellow;">Nationality  </lable>&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="m_name"id="txt2"><br><br>
          &nbsp;&nbsp;<label style="color:yellow;">Birth Date  </lable>&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="m_name"id="txt2">
          &nbsp;&nbsp;
          </select><br><br>
